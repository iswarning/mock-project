  ...
  return (
    <div className='task'>
        <div className='task__tags d-flex justify-content-between'>
            <div>
            <span className={`task__tag task__tag--copyright`}>{task.project_name}</span>
            </div>
            <div className="dropdown">
                ...
                <ul className="dropdown-menu" aria-labelledby={`dropdown-${task.id}`}>
                    <li><a className="dropdown-item" role="button"><i className="fa-solid fa-pen-to-square"></i> Edit</a></li>
                    <li><a className="dropdown-item" role="button"><i className="fa-solid fa-trash"></i> Delete</a></li>
                </ul>
            </div>
        </div>
        <p>{task.note}</p>
